...
text_2 = '<p style="font-family:sans-serif; color:#4d372c; font-size: 20px;">In this dashboard, we\'ll take a closer look at the utilization of Uniswap across the following chains — Arbitrum, Avalanche, Base, BSC, Optimism, and Polygon. While some of these chains may technically be categorized as sidechains rather than exclusively Layer 2, for the sake of clarity, we choose to include them under the broader term of L2. We\'ll unravel the details and common trends that define Uniswap\'s functionality within these scaling environments.</p>'
